...
#df_train_cropped = df_train_cropped[['smiles','feat_001','feat_025', 'feat_102', 'feat_119', 'feat_126',\
#     'feat_187', 'feat_218', 'feat_251', 'gap']]
#df_train_cropped = df_train_cropped[['smiles','gap']]
